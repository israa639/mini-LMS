    ...
    <body>
     ...
     <div class="container" >
         <div class="row">
             ...
             <div class="col-lg-6">
                 <form class="form-group" action="answer_questionServlet" method="post">
                     
                     <label class="font">Question_ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                     <input class="input1" type="text" name="question_id" /> <br>
                     <label class="font">Answer :</label> <br> 
                     <textarea class="input2"  name="answer"></textarea><br>
                     <button>Send</button>
