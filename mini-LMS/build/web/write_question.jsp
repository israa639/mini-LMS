    ...
    <body>
     ...
     <div class="container" >
         <div class="row">
             ...
             <div class="col-lg-6">
                 <form class="form-group" action="write_questionServlet" method="post">
                     
                     <label class="font">Course code :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                     <input class="input1" type="text" name="course_code"   /> <br> 
                     <label class="font">Subject :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                     <input class="input1" type="text" name="subject"   /> <br> 
                     <label class="font">Question :</label> <br> 
                     <textarea class="input2"  name="question"></textarea><br>
                     <button>Send</button>
