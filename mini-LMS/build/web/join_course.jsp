...
::-webkit-input-placeholder{
    ...
    <body>
        ...
        <div class="container" >
         <div class="row">
             ...
             <div class="col-lg-6">
                 ...
                 <form class="form-group" action="join_courseServlet" method="post">
                     <label  >Course Code :</label>
                     <input type="text" name="course_code"  class="lec" /><br>   
     ...
     <!-- javascript -->
        ...
        function generate() 
        {
            alert('You have joined '+c.getCourseName()+' course successfully ');     
        }
    </script>
